  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      if (error.response && error.response.data && error.response.data.message) {
        ...
        console.error('Erro ao fazer upload da imagem: ', error.response.data.message);
